  ...
  async function fetchActivities() {
    try {
      ...
      Object.entries(activities).forEach(([name, details]) => {
        ...
        const participantsList = details.participants.map(p => `<li><span class="participant-email">${p}</span><span class="delete-icon" data-activity="${name}" data-email="${p}" title="Remove participant">✕</span></li>`).join('');
